...
MODULE_FIRMWARE(IPU6_FIRMWARE_NAME);
MODULE_FIRMWARE(IPU6SE_FIRMWARE_NAME);
MODULE_FIRMWARE(IPU6EP_FIRMWARE_NAME);
MODULE_FIRMWARE(IPU6EPADLN_FIRMWARE_NAME);
MODULE_FIRMWARE(IPU6EPMTL_FIRMWARE_NAME);
